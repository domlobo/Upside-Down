...
class LevelLoader:
    ...
    def __init__(self,player,inter):
        ...
        self.levels = (marioOne,)#(tutorialOne,tutorialTwo,tutorialThree,marioOne)
        self.enemyFiles =("enemies/marioOne.txt",)#("enemies/tutorialOne.txt","enemies/tutorialTwo.txt","enemies/tutorialThree.txt","enemies/marioOne.txt")
