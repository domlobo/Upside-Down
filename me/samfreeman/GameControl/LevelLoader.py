...
class LevelLoader:
    ...
    def __init__(self,player,inter, state):
        ...
        self.levels =[marioThree,]#[tutorialOne,tutorialTwo,tutorialThree,marioOne,marioTwo,marioThree,doomOne]
        self.enemyFiles =("enemies/marioThree.txt",)#("enemies/tutorialOne.txt","enemies/tutorialTwo.txt","enemies/tutorialThree.txt","enemies/marioOne.txt","enemies/marioTwo.txt","enemies/marioThree.txt","enemies/doomOne.txt")
