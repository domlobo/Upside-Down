...
class MainMenu:
    def __init__(self, frame):
        ...
        self.titleWidth = frame.get_canvas_textwidth(self.title, 30)
        self.startText = "Press Space to Play"
        self.startTextWidth = frame.get_canvas_textwidth(self.startText, 45)
    ...
    def draw(self, canvas):
        ...
        canvas.draw_text(self.startText, ((GV.CANVAS_WIDTH - self.startTextWidth) / 2, GV.CANVAS_HEIGHT / 2), 30, "White", "monospace")